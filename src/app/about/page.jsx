  ...
  return (
    <div className="min-h-screen w-full bg-grid-pattern relative">
      ...
      <main className="container mx-auto px-4 sm:px-6 pt-24 pb-12">
        ...
        {/* Mission Statement */}
        <div className="glass-elevated p-8 sm:p-10 rounded-2xl shadow-xl border border-gray-200/50 mb-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-16">
          {/* Independence */}
          <div className="card p-6 sm:p-8 text-center group hover:shadow-lg transition-all duration-200">
            <div className="w-16 h-16 bg-green-100 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:bg-green-200 transition-colors">
              <Shield size={32} className="text-green-600" />
            </div>
            <h3 className="text-xl font-bold text-gray-900 mb-4">Editorial Independence</h3>
          ...
          <div className="card p-6 sm:p-8 text-center group hover:shadow-lg transition-all duration-200">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-4">Transparent Algorithm</h3>
            <p className="text-gray-600 leading-relaxed">
        ...
        <div className="glass-elevated p-8 sm:p-10 rounded-2xl shadow-xl border border-gray-200/50 mb-16">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">How We Ensure Quality</h2>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-2">Authentic Review Analysis</h4>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-2">Professional Verification</h4>
                  <p className="text-gray-600 text-sm leading-relaxed">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-2">Complete Privacy Protection</h4>
                  <p className="text-gray-600 text-sm leading-relaxed">
        ...
        <div className="glass-elevated p-8 sm:p-10 rounded-2xl shadow-xl border border-gray-200/50 mb-16">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">Our Commitment to Transparency</h2>
          </div>

          <div className="grid sm:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Sponsorship Transparency</h3>
            ...
            <div>
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Data Privacy Guarantee</h3>
              <div className="space-y-4 text-gray-700">
                <p className="leading-relaxed">
                  Your privacy and data security are non-negotiable. We've built our system with privacy-first principles.
                </p>
                <div className="bg-green-50 p-4 rounded-lg border border-green-200">
                  <p className="text-sm font-medium text-green-900 mb-2">Privacy Promise:</p>
        ...
        <div className="text-center max-w-4xl mx-auto">
          <div className="glass-elevated p-8 sm:p-12 rounded-2xl shadow-xl border border-gray-200/50">
            <div className="w-16 h-16 bg-gradient-to-br from-green-500 to-green-600 rounded-2xl flex items-center justify-center mx-auto mb-6">
              <Heart size={32} className="text-white" />
            </div>
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">Our Promise to You</h2>
            <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed">
