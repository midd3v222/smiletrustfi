  ...
  const initializeClinicSearch = () => {
    ...
    navigator.geolocation.getCurrentPosition(
      ...
      (error) => {
        ...
        // Don't set error, just fall back to popular destinations
        setPopularDestinations(POPULAR_DESTINATIONS.europe);
        setActiveTab("popular");
        findPopularClinics();
      },
                  ...
                  <div className="text-center py-12">
                    <div className="glass-elevated p-8 rounded-xl max-w-lg mx-auto border border-gray-200">
                      <div className="flex items-center justify-center gap-2 mb-4">
                        ...
                        <h3 className="font-semibold text-gray-800">Location Access Required</h3>
                      </div>
                      <p className="text-gray-600 mb-6 text-sm leading-relaxed">
                        To show nearby certified dental professionals, we need access to your location. 
                        Your privacy is protected and location data is not stored.
                      </p>
                      <button
                        onClick={() => {
